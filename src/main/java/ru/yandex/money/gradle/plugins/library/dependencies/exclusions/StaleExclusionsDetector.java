...
/**
 * Определяет неиспользуемые правила исключений на основании зарегистрированных конфликтов версий.
 * Исключение считается неиспользуемым, если для него не было зарегистрировано ни одног конфликта
 *
...
public class StaleExclusionsDetector {
    ...
    /**
     * Возвращает неиспользуемые исключения
     *
