...
#### Настройки проверки наличия запрещенных артефактов в подключаемых библиотеках
   ...
   Список запрещенных артефактов задается следующим образом:
```groovy
...
```
Такая настройка означает, что запрещены: 
 * yamoney-xml-utils версии 4.0.0
 * yamoney-json-utils всех версий, больше 4.2.0
 * yamoney-json-utils всех версий, меньше 2.1.4
